...
class GridWorld(object):
    ...
    def step(self, action):
        ...
        if not self.offGridMove(resultingState, self.agentPosition):
            ...
            # In OpenAI Gym, return [new state] [reward] [if the task is over] [debug information]
        ...
        for row in self.grid:
            for col in row:
                if col == 0:    # empty square
                    print('-', end='\t')
                elif col == 1:  # if agent is there
                    print('X', end='\t')
                elif col == 2:  # entrance of first magic square
                    print('Ain', end='\t')
                elif col == 3:  # exit of first magic square
                    print('Aout', end='\t')
                elif col == 4:  # entrance of second magic square
                    print('Bin', end='\t')
                elif col == 5:  # exit of second magic square
                    print('Bout', end='\t')
            print('\n')
        print('--------------------------')
...
if __name__ == '__main__':
    ...
    # Plot total rewards at the end of all episodes
